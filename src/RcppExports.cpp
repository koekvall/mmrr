...
RcppExport SEXP _lvmmrPQL_working_ll_rcpp(SEXP Y_TSEXP, SEXP X_TSEXP, SEXP betaSEXP, SEXP SigmaSEXP, SEXP W_TSEXP, SEXP psiSEXP, SEXP D1_TSEXP, SEXP D2_TSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
